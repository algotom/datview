...
class InteractiveViewerWindow(BaseWindow):
    ...
    def _setup_ui(self):
        ...
        if self.file_type == "hdf" or self.depth > 1:
            ...
            self.lbl_slice0.setFixedWidth(55)
            self.lbl_slice0.setAlignment(Qt.AlignCenter)
            self.lbl_slice0.setValidator(QIntValidator(0, self.depth - 1,
                                                       self.lbl_slice0))
            self.lbl_slice0.editingFinished.connect(
                self.on_slice0_input_changed)
        ...
        if self.file_type == "hdf" and self.height > 1 and self.depth > 1:
            ...
            self.lbl_slice1.setFixedWidth(55)
            ...
            self.lbl_slice1.editingFinished.connect(
                self.on_slice1_input_changed)
        ...
        self.lbl_aspect.setFixedHeight(util.BTN_H)
        self.combo_aspect.setFixedWidth(max_w)
        if hasattr(self, "lbl_slice0") and self.lbl_slice0 is not None:
...
class ExportDialog(BaseWindow):
    ...
    def __init__(self, parent_app, file_path, file_type, hdf_key=None,
        ...
        self.txt_path.setMinimumHeight(util.BTN_H)
        ...
        self.combo_axis.setFixedHeight(util.BTN_H)
        if file_type == "cine":
        ...
        self.combo_rescale.setFixedHeight(util.BTN_H)
        ...
        self.edt_prefix.setFixedHeight(util.BTN_H)
        ...
        self.btn_export.setFixedHeight(util.BTN_H)
...
class DatviewMainWindow(QMainWindow):
    ...
    def __init__(self, base_folder="."):
        ...
        header_layout.setSpacing(util.UI_SPACING_S)
        ...
        btn_select_folder.setFixedHeight(util.BTN_H)
        ...
        self.combo_theme.setFixedHeight(util.BTN_H)
        ...
        self.combo_theme.currentTextChanged.connect(
            lambda val: self.sig_theme_changed.emit(val))
        ...
        header_layout.addSpacing(util.UI_MARGIN_S)
        ...
        vs_layout.setContentsMargins(util.UI_MARGIN_S, util.UI_MARGIN_M,
                                     0, 0)
